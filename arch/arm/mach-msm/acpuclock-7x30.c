...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 368640,  PLL_3,    5, 1,  	 122800000, 875,  VDD_RAW(875),  LOW },
	...
	{ 1, 768000,  PLL_1,    2, 0,    153600000, 1000,  VDD_RAW(1000),  NOMINAL },
	{ 1, 800000,  PLL_2,    3, 0,    UINT_MAX,  1000,  VDD_RAW(1000),  NOMINAL, &pll2_tbl[3]},
	{ 1, 900000,  PLL_2,    3, 0,    UINT_MAX,  1025, VDD_RAW(1025), NOMINAL, &pll2_tbl[4]},
	{ 1, 1000000, PLL_2,    3, 0,    UINT_MAX,  1100, VDD_RAW(1100), NOMINAL, &pll2_tbl[5]},
	{ 1, 1100000, PLL_2,    3, 0,    UINT_MAX,  1125, VDD_RAW(1125), NOMINAL, &pll2_tbl[6]},
	{ 1, 1200000, PLL_2,    3, 0,    UINT_MAX,  1175, VDD_RAW(1175), NOMINAL, &pll2_tbl[7]},
